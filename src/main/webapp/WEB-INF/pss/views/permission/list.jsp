...
<body>
	<s:form id="searchForm" action="permission_list" method="post" namespace="/pss">
		<div id="container">
				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							...
							<input type="button" value="加载权限" class="ui_input_btn01 loadpermission_btn" data-href='<s:url action="permission_reload" namespace="/pss"/>'/>
						</div>
					</div>
				</div>
			</div>
			<div class="ui_content">
						...
						<tbody>
							<s:iterator value="#pageResult.listData">
								<tr>
									...
									<td>
										<s:a action="permission_delete" namespace="/pss">
											<s:param name="permission.id" value="id"/>删除
										</s:a>
									</td>
								</tr>
							</s:iterator>
				...
				<%@include file="/WEB-INF/pss/views/common/common_page.jsp" %>
			</div>
		</div>
	</s:form>
</body>
